...
All simulations use the same grids for \(\alpha,p,\delta,\lambda\) under both mechanisms (FDCM/FICM), identical sample sizes, and fixed random seeds per scenario; code is available upon request.
